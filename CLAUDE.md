# azurelocal-iot — Claude Code Context
...
- `azurelocal-iot-engineer` (model: sonnet) — Expert in `azurelocal-iot`: deep knowledge of this repo's structure, conventions, and development workflow.
